import type { ImageLodBucket } from '@/features/graph-runtime/avatar'
...
export const DEFAULT_AVATAR_HD_ZOOM_THRESHOLD = 1.0
export const DEFAULT_AVATAR_FULL_HD_ZOOM_THRESHOLD = 1.5
