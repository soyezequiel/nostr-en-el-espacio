import { createDiscoveredGraphAnalysisKey } from '@/features/graph-runtime/analysis/analysisKey'
import type { AnalyzeDiscoveredGraphRequest } from '@/features/graph-runtime/workers/graph/contracts'
import type { KernelContext } from '@/features/graph-runtime/kernel/modules/context'
import { DISCOVERED_GRAPH_ANALYSIS_LOADING_MESSAGE } from '@/features/graph-runtime/kernel/modules/constants'
import { buildDiscoveredGraphAnalysisMessage } from '@/features/graph-runtime/kernel/modules/text-helpers'
