...
export const NODE_EXPAND_RECIPROCAL_AUTHOR_CHUNK_SIZE = 100
export const NODE_EXPAND_RECIPROCAL_QUERY_CONCURRENCY = 2
export const NODE_EXPAND_RECIPROCAL_MIN_CANDIDATE_CAP = 48
export const NODE_EXPAND_RECIPROCAL_MAX_CANDIDATE_CAP = 420
export const NODE_EXPAND_RECIPROCAL_NODE_BUDGET_WEIGHT = 0.15
export const NODE_EXPAND_RECIPROCAL_PROFILE_CANDIDATE_CAPS = {
  desktop: 420,
  mobile: 180,
  'low-end-mobile': 96,
} as const
